package com.vini.money.api.excepcionhandler;
...
public class MoneyExceptionHandler extends ResponseEntityExceptionHandler{
	...
	/**
	 * Capturando mensagens que nao conseguiu ler, como exemplo, usuario enviando campo extras nos body
	 */
	@Override
	...
	/**
	 * Capturando argumentos que nao sao validos, validado pelo bean validation
	 */
	@Override
